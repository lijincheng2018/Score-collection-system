...
<div class="col-xs-12 col-sm-10 col-lg-8 center-block" style="float: none;"><br>
 ...
 ?>
  尊敬的<font color=red>李锦成（总管理员）</font>，欢迎您！<br><br>
  <center><font size=5 color=orange>2019年福建省初中学生毕业和高中阶段学校招考试</font></center><br>
  <center><font size=3 color=orange>成绩报告</font></center><br>
...
$result1=mysql_query("SELECT * FROM students ORDER BY uid asc");
...
for($i=0;$i<$dataCount;$i++){
  ...
  $result_arr1=mysql_fetch_assoc($result1);
    $sex=$result_arr1['sex'];

  
    	$result_arr=mysql_fetch_assoc($result);
        $uid=$result_arr['id'];
        $uid_id=$result_arr1['uid'];
