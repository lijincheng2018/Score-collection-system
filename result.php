...
include('./config.php'); $name=$_SESSION['name'];$result=mysql_query("SELECT * FROM user where name='$name' limit 1");$result_arr=mysql_fetch_assoc($result);$numm=$result_arr['uid'];
?>
<!DOCTYPE html>
<html>
	<head>
